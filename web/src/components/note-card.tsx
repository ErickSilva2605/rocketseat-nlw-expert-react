  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className='fixed overflow-hidden inset-0 md:inset-auto md:rounded-md md:h-[60vh] md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full bg-slate-700 flex flex-col outline-none'
        >
          ...
          <button
            type='button'
            className='w-full py-4 bg-slate-800 font-medium text-sm text-center text-slate-300 outline-none group'
          >
